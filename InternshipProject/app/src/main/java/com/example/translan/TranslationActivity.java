...
import static com.example.translan.GlobalVars.BASE_REQ_URL;
import static com.example.translan.GlobalVars.DEFAULT_LANG_POS1;
import static com.example.translan.GlobalVars.DEFAULT_LANG_POS2;
import static com.example.translan.GlobalVars.LANGUAGE_CODES;
    ...
    private class GetLanguages extends AsyncTask<Void,Void,ArrayList<String>>{
        ...
        protected void onPostExecute(ArrayList<String> result) {
            if (activityRunning) {
                ...
                mSpinnerLanguageFrom.setSelection(DEFAULT_LANG_POS1);
